...
This experiment was created using PsychoPy3 Experiment Builder (v2021.1.4),
    on Thu 08 Jul 2021 12:14:26 PM EDT
...
def determine_diagonal(start_coord_left_line, length, direction = 1):
    start_x = start_coord_left_line[0]
    start_y = start_coord_left_line[1]
    end_coord_left_line_x = start_x + direction * (length * cos(1.0472))
    end_coord_left_line_y = start_y - (length * sin(1.0472))
...
'diagonal1': [[(-200, 50), determine_diagonal((-200, 50), length)], [(200, 50), determine_diagonal((200, 50), length)]],
'diagonal2': [[(-200, 50), determine_diagonal((-200, 50), length, direction = -1)], [(200, 50), determine_diagonal((200, 50), length, direction = -1)]]
}
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        start_left_line = RotationCondition[condition][0][0]
        end_left_line = RotationCondition[condition][0][1]
        start_right_line = RotationCondition[condition][1][0]
        end_right_line = RotationCondition[condition][1][1]
