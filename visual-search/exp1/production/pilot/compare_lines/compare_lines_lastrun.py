...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lilyspencer/NHI/nhi-experiments/visual-search/exp1/production/pilot/compare_lines/compare_lines_lastrun.py',
...
for thisBlock in blocks:
    ...
    ## fill width array
    line_widths = list(np.linspace(1, max_width, n_lines))
    key_resp_2.keys = []
    key_resp_2.rt = []
    _key_resp_2_allKeys = []
    # keep track of which components have finished
